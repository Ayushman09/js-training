...
{
    let randomNumberValue=randomGenerator(1,100);
    document.getElementById("p1").innerHTML=randomNumberValue;
}
...
function loremSentence()
{
    ...
    {
        resultSentences=resultSentences+newlorem[index]+"."

    }
    document.getElementById("p4").innerHTML=resultSentences
}
...
function loremChars()
{
    ...
    for(let index=0;index<len;index++)
    {
        resultChars=resultChars+newlorem[index]

    }
    document.getElementById("p5").innerHTML=resultChars
}
...
function passwordValidator() {
    ...
    if (str.match(/[a-z]/g) && str.match(
        ...
        res = "INVALID";
    console.log(res);
    document.getElementById("p15").innerHTML = res;
